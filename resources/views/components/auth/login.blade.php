...
@section('contenido')
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a href="{{ route('index') }}"><img src="./assets/img/logo-sedipro.png" class="img-fluid" alt="Logo-SediproUNT"></a>
                </div>
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    {{-- <a href="/google-auth/redirect" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">
                        <img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png"
                            alt="Google" height="50" width="25"> Iniciar sesión con Google
                    </a> --}}
