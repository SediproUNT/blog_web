<ul class="menu">
    ...
    <li class="sidebar-title">Perfiles</li>

    <li class="sidebar-item  has-sub">
        <a href="#" class='sidebar-link'>
            <i class="bi bi-stack"></i>
            <span>Sedipranos</span>
        </a>

        <ul class="submenu ">

            <li class="submenu-item  ">
                <a href="{{ route('profiles.create') }}" class="submenu-link">Crear</a>
            </li>

            <li class="submenu-item  ">
                <a href="{{ route('profiles.index') }}" class="submenu-link">Ver</a>
            </li>
    ...
    <li class="sidebar-title"><i class="fas fa-blogger    "></i></li>
    ...
    <li class="sidebar-item  has-sub">
        ...
        <ul class="submenu ">
            ...
            <li class="submenu-item  ">
                <a href="{{ route('posts.create') }}" class="submenu-link">Crear</a>
            </li>

            <li class="submenu-item  ">
                <a href="{{ route('posts.index') }}" class="submenu-link">Ver</a>
            </li>
        </ul>
    </li>
    ...
    <li class="sidebar-item  has-sub">
        ...
        <ul class="submenu ">
            ...
            <li class="submenu-item  ">
                <a href="{{ route('logros.create') }}" class="submenu-link">Crear</a>
            </li>

            <li class="submenu-item  ">
                <a href="{{ route('logros.index') }}" class="submenu-link">Ver</a>
            </li>
        </ul>
    </li>
    ...
    <li class="sidebar-item  has-sub">
        ...
        <ul class="submenu ">
            ...
            <li class="submenu-item  ">
                <a href="{{ route('convenios.create') }}" class="submenu-link">Crear</a>
            </li>

            <li class="submenu-item  ">
                <a href="{{ route('convenios.index') }}" class="submenu-link">Ver</a>
            </li>
        </ul>
    </li>
    ...
    {{-- <li class="sidebar-item  has-sub">
        ...
        <ul class="submenu ">
            ...
            <li class="submenu-item  ">
                <a href="{{ route('categories.create') }}" class="submenu-link">Crear</a>
            </li>

            <li class="submenu-item  ">
                <a href="{{ route('categories.index') }}" class="submenu-link">Ver</a>
            </li>
        </ul>
    </li> --}}
