...
@section('contenido')
    ...
    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2 gap-4 mb-4">
        <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-9">
            <div class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl shadow-lg w-100 p-4 mb-4">
                <div class="d-flex justify-content-between">
                    <p class="text-dark">
                        <span class="font-weight-medium border-bottom border-dashed border-danger">Latest Posts </span>
                    </p>
                    <p class="text-dark">
                        <span class="font-weight-medium">Today </span>: 21 August 2023
                    </p>
                </div>
            </div>
            <div class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl shadow-lg w-100 p-4 mb-4">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 gap-4">
                    ...
                    <div class="col-12 col-sm-6 col-md-8 col-lg-8 col-xl-8">
                        <div class="h-100 d-flex flex-column p-3">
                            <div class="w-100">
                                <span class="text-sm bg-danger bg-opacity-10 text-danger rounded font-weight-medium py-1 px-2 inline-block mb-3">Health</span>
                            ...
                            <div class="d-flex flex-wrap justify-content-between mt-auto">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <p tabindex="0" class="text-secondary text-xs font-weight-medium">San Diego, California</p>
                                    </div>
                                </div>
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-3">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-1 row-cols-xl-1 gap-4 mb-4">
                <div class="col-12 col-sm-12 col-md-6 col-lg-12 col-xl-12">
                    <div class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl shadow-lg w-100 p-4">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 gap-4">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                <div class="h-100 d-flex flex-column p-3">
                                    <div class="w-100">
                                        <span class="text-sm bg-success bg-opacity-10 text-success rounded font-weight-medium py-0 px-2 inline-block mb-3">Fashion</span>
                                        <span class="text-dark font-weight-medium text-xs ms-2">23 August 2023</span>
                                    </div>
