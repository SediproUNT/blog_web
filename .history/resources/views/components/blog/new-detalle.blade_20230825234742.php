...
@section('contenido')
    ...
    <div class="container mil-mb-120"><div class="mil-pagination mil-hidden-button"><a class="mil-slider-nav" href="/project"><div class="mil-slider-btn-prev mil-button-sm mil-blog-prev"><i class="fas fa-arrow-left"></i><span class="mil-h6">Prev</span></div></a><a class="mil-button-all" href="/portfolio"><span><i class="fas fa-list"></i></span></a><div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next" href="/project"><span class="mil-h6">Next</span><i class="fas fa-arrow-right"></i></a></div></div></div>
