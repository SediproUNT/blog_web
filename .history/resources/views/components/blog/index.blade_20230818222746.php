...
@section('contenido')
    ...
    <section class="bg-light">
        ...
        <div class="carousel">
            <div id="carouselLogros" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($logros as $key => $logro)
                        <div class="carousel-item{{ $key === 0 ? ' active' : '' }}">
                            <!-- Aquí puedes mostrar los detalles del logro, como título, descripción, imagen, etc. -->
                            <h2>{{ $logro->titulo }}</h2>
                            <p>{{ $logro->descripcion }}</p>
                            <img src="{{ $logro->imagen_url }}" alt="{{ $logro->titulo }}">
                        </div>
                    @endforeach
                </div>
                <a class="carousel-control-prev" href="#carouselLogros" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="sr-only">Anterior</span>
                </a>
                <a class="carousel-control-next" href="#carouselLogros" role="button" data-slide="next">
