...
@section('styles')
    <style>
        ...
        .breadcrumbs a {
            color: #aaa; /* Cambia el color del enlace si es necesario */
        }

        .breadcrumbs a:hover {
            color: #db5940; /* Cambia el color del enlace al pasar el cursor si es necesario */
        }
        ...
        .noticias {
            text-align: center; /* Centra el contenido */
            margin: 40px 0; /* Ajusta el margen superior e inferior según tu diseño */
        }

        .noticias article {
            margin-bottom: 30px; /* Ajusta el margen inferior entre artículos */
            padding: 20px;
            border: 1px solid #ccc; /* Añade un borde a los artículos si lo deseas */
...
@section('contenido')
    ...
    <div class="noticias">
        ...
        <article>
            <!-- Contenido de la segunda noticia -->
        </article>
