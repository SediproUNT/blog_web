...
@section('styles')
<style>
    /* Cambia el color del texto y el cursor al pasar por encima */
.mil-slider-btn-next.disabled .disabled-text:hover {
    color: #999; /* Cambia este color según tus preferencias */
    cursor: default;
}

/* Cambia la opacidad del botón al pasar por encima */
.mil-slider-btn-next.disabled:hover {
    opacity: 0.7; /* Cambia este valor según tus preferencias */
}
        ...
        <div class="mil-pagination mil-hidden-button">
            ...
            @else
                <div class="mil-slider-nav">
                    <a class="mil-slider-btn-next mil-blog-next disabled">
                        <span class="mil-h6 disabled-text">Más antiguos</span><i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            @endif
        </div>
