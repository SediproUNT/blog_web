    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="bg-opacity-40 backdrop-blur-2xl rounded-2xl p-4 mb-4" style="background-color: #f6f9ff;">
                ...
                <div class="h-100 d-flex flex-column p-3">
                    <article class="bg-opacity-40 backdrop-blur-2xl rounded-2xl p-4 mb-4 style="background-color: #f6f9ff;"">
