...
.banner-heading h1 {
    margin: 0;
    padding: 0;
    font-size: 24px; /* Ajusta el tamaño de fuente según tu preferencia */
    color: #fff; /* Cambia el color de texto si es necesario */
}

.breadcrumbs {
    margin-top: 10px; /* Ajusta el margen según tu diseño */
    font-size: 14px; /* Ajusta el tamaño de fuente según tu preferencia */
    color: #aaa; /* Cambia el color de texto si es necesario */
}

.bg-stretch img {
    width: 100%; /* La imagen ocupará el ancho completo del contenedor */
    height: auto; /* La altura se ajustará automáticamente */
    display: block; /* Para asegurar que la imagen sea un elemento en bloque */
}
...
@section('contenido')
    ...
    <div class="banner-block">
        ...
        <div class="bg-stretch">
            <img src="URL_DE_LA_IMAGEN" alt="image description"
