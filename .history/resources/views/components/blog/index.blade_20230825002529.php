...
@section('styles')
    ...
    position: relative;
    width: 50%; /* Ajusta este valor según el tamaño deseado de la imagen principal */
    height: 0;
    padding-bottom: 25%; /* Ajusta este valor según la relación de aspecto de tus imágenes */
    background-size: cover;
    background-position: center;
    margin: 0 auto; /* Centra horizontalmente la imagen */
}

.mil-card .mil-cover-frame::before {
    content: "";
    position: absolute;
    top: 0;
    left: -50%; /* Ajusta este valor para controlar el desenfoque en los costados */
    width: 200%; /* Ajusta este valor para controlar el desenfoque en los costados */
    height: 100%;
