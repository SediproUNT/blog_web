...
@section('contenido')
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 gap-4">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                <div class="position-relative">
                                    ...
                                    <span class="position-absolute top-0 end-0 text-dark font-weight-medium text-xs ms-2">{{ $post->created_at->format('d F Y') }}</span>
                                </div>
                            </div>
    ...
    <section class="mil-p-120-120"><div class="container"><div class="row justify-content-between align-items-center"><div class="col-xl-6 mil-mb-60"><div class="mil-project-cover"><img src="img/projects/2.jpg" alt="Project"></div></div><div class="col-xl-5 mil-mb-60"><span class="mil-suptitle mil-suptitle-2 mil-mb-30">The majority have suffered alteration in some form.</span><h3 class="mil-mb-30">Android App For Shaving Products Delivery</h3><a class="mil-button-with-label" href="/project"><div class="mil-button mil-border mil-icon-button"><span><i class="fas fa-plus"></i></span></div><span class="mil-dark">See More</span></a></div></div><div class="row flex-sm-row-reverse justify-content-between align-items-center"><div class="col-xl-6 mil-mb-60"><div class="mil-project-cover mil-type-2"><img src="img/projects/3.jpg" alt="Project"></div></div><div class="col-xl-5 mil-mb-60"><span class="mil-suptitle mil-suptitle-2 mil-mb-30">The majority have suffered alteration in some form.</span><h3 class="mil-mb-30">Android App For Shaving Products Delivery</h3><a class="mil-button-with-label" href="/project"><div class="mil-button mil-border mil-icon-button"><span><i class="fas fa-plus"></i></span></div><span class="mil-dark">See More</span></a></div></div><div class="row justify-content-between align-items-center"><div class="col-xl-6 mil-mb-60"><div class="mil-project-cover"><img src="img/projects/1.jpg" alt="Project"></div></div><div class="col-xl-5 mil-mb-60"><span class="mil-suptitle mil-suptitle-2 mil-mb-30">The majority have suffered alteration in some form.</span><h3 class="mil-mb-30">Android App For Shaving Products Delivery</h3><a class="mil-button-with-label" href="/project"><div class="mil-button mil-border mil-icon-button"><span><i class="fas fa-plus"></i></span></div><span class="mil-dark">See More</span></a></div></div><div class="mil-divider mil-mb-60"></div><div class="mil-pagination mil-hidden-arrows"><div class="mil-slider-nav"><div class="mil-slider-btn-prev mil-blog-prev"><i class="fas fa-arrow-left"></i><span class="mil-h6">Prev</span></div></div><ul class="mil-pagination-numbers"><li class="mil-active"><a href="/portfolio">1</a></li><li><a href="/portfolio">2</a></li><li><a href="/portfolio">3</a></li></ul><div class="mil-slider-nav"><div class="mil-slider-btn-next mil-blog-next"><span class="mil-h6">Next</span><i class="fas fa-arrow-right"></i></div></div></div></div></section>
