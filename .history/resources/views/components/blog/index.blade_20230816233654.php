...
<style>
    .carousel-image {
        max-width: 100px; /* Ajusta el tamaño deseado */
        height: auto;
    }
</style>
...
@section('contenido')
    ...
    <section class="bg-light">
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">Logros</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div id="logrosCarosuel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carosuel-inner">
                        @foreach ($logros as $index => $logro)
                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                <img src="{{ $logro->url_logros }}" class="d-block mx-auto img-fluid" alt="{{ $logro->nombre }}">
                            </div>
                            @if ($index === 4)
                                @break
                            @endif
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#logrosCarosuel"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden"></span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#logrosCarosuel"
                        data-bs-slide="next">
