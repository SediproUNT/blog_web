...
@section('styles')
    <style>
        ...
        .mil-button-sm.disabled,
        .mil-blog-next.disabled,
        .mil-blog-prev.disabled {
            filter: blur(4px);
            /* Aplicar desenfoque */
            pointer-events: none;
            /* Deshabilitar interacción con el botón */
        }

        /* Estilos para el ícono de círculo rojo */
        .mil-blog-next.disabled::before,
        .mil-blog-prev.disabled::before {
            content: '\f111';
            /* Código del icono de círculo rojo */
