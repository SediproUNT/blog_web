    ...
    <section class="bg-light">
        ...
        <div class="container">
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="mil-adaptive-right">
                        <div class="mil-slider-nav mil-mb-30">
                            {{-- <div class="mil-slider-btn-prev swiper-button-prev"><i class="fas fa-arrow-left"></i><span
                                    class="mil-h6">Prev</span></div>
                            <div class="mil-slider-btn-next swiper-button-next"><span class="mil-h6">Next</span><i
            ...
            <div
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-b2336b49791b3a6c" aria-live="polite"
                    ...
                    @foreach ($posts as $post)
                        <div class="swiper-slide swiper-slide-active" style="width: 444.5px; margin-right: 30px;"
                            role="group" aria-label="1 / 4"><a class="mil-card" href="/project">
                                <div class="mil-cover-frame">
                                    {{-- <img src="img/projects/1.jpg" alt="Easy &amp; Most Powerful Server Platform."> --}}
                                    <img src="{{ $post->image_url }}" class="card-img-top" alt="{{ $post->title }}"
                                        style="max-width: 600px; height: auto;">
                                </div>
                                <div class="mil-description">
                                    <div class="mil-card-title">
                                        ...
                                        <h6>Fecha: <span class="mil-accent">
                                                {{ $post->created_at->format('d-m-Y') }}</span></h6>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-xl-6"><a class="mil-link mil-mb-30" href="/portfolio"><span>Ver todas las
        ...
        <div class="container">
            <div class="row align-items-center mil-mb-60-adapt">
                ...
                <div class="col-12 col-md-6 col-xl-6 d-flex justify-content-end">
                    <div class="mil-slider-nav mil-mb-30">
                        <div class="mil-slider-btn-prev mil-works-prev" tabindex="0" role="button" aria-label="Previous slide">
                            <i class="fas fa-arrow-left"></i><span class="mil-h6">Prev</span>
                        </div>
                        <div class="mil-slider-btn-next mil-works-next" tabindex="0" role="button" aria-label="Next slide">
                            <span class="mil-h6">Next</span><i class="fas fa-arrow-right"></i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper swiper-container swiper-initialized swiper-horizontal mil-works-slider mil-mb-90 swiper-backface-hidden">
                <div class="swiper-wrapper" id="swiper-wrapper-b2336b49791b3a6c" aria-live="polite">
                    @foreach ($posts as $post)
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6 col-xl-6"><a class="mil-link mil-mb-30" href="/portfolio"><span>Ver todas las
                            noticias</span><i class="fas fa-arrow-right"></i></a></div>
            </div>
        </div>
