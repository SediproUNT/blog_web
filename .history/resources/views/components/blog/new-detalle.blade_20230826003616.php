        ...
        <div class="mil-pagination mil-hidden-button">
            @if ($nextPostId )
                <a class="mil-slider-nav" href="{{ route('news.show', ['id' => $nextPostId ]) }}">
                    <div class="mil-slider-btn-prev mil-button-sm mil-blog-prev">
                        <i class="fas fa-arrow-left"></i><span class="mil-h6">Más antiguos</span>
                    </div>
                </a>
            @else
            ...
            @if ($previousPostId)
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next"
                        href="{{ route('news.show', ['id' => $previousPostId]) }}"><span class="mil-h6">Más reciente</span><i
                            class="fas fa-arrow-right"></i></a></div>
            @else
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next disabled"><span class="mil-h6">Más reciente</span><i class="fas fa-arrow-right"></i></a></div>
            @endif
        </div>
    </div>
