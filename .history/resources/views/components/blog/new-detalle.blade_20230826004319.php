...
@section('contenido')
    ...
    <div class="container mil-mb-120">
        <div class="mil-pagination mil-hidden-button">
            ...
            @if ($nextPostId)
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next more-ancient-link"
                        href="{{ route('news.show', ['id' => $nextPostId]) }}"><span class="mil-h6">Más antiguos</span><i
                            class="fas fa-arrow-right"></i></a></div>
            @else
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next disabled more-ancient-link"><span class="mil-h6">Más
