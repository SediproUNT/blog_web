...
@section('styles')
    <style>
        ...
        .content-news li.breadcrumb-item.active:hover, .content-news li.breadcrumb-item a:hover {
            color:#3454a2;
            background: white;
        }

        .content-news li.breadcrumb-item.active:hover::before {
            background: black;
        }
                    ...
                    <header class="banner-heading content-news">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-header" >
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><spanp>Posts</spanp></li>
                            </ol>
                        </nav>
                    </header>
                </div>
