...
@section('styles')
    <style>
        ...
        .slick-slide {
            padding: 0 5px; /* Ajusta el margen horizontal entre las imágenes */
        }

        .slick-prev,
        .slick-next {
            background-color: blue; /* Cambia el color de los botones a azul */
        }
    </style>
@endsection
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.slick-slider').slick({
                ...
                responsive: [{
                        breakpoint: 992, // Cambiar la cantidad de imágenes visibles en pantallas medianas
                        settings: {
                            slidesToShow: 3
                        }
                    },
