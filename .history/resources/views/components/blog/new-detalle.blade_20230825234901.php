...
@section('contenido')
    ...
    <div class="container mil-mb-120">
        <div class="mil-pagination mil-hidden-button"><a class="mil-slider-nav" href="/project">
            ...
            <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next" href="/project"><span class="mil-h6">Next</span><i class="fas fa-arrow-right"></i><i class="fas fa-arrow-right"></i></a></div>
        </div>
    </div>
