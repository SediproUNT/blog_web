...
@section('contenido')
    ...
    {{-- <div class="container py-5">
        <div class="row">
            <div class="col-12 col-lg-8 cont">
                <div class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl p-4 mb-4">
                ...
                <div class="h-100 d-flex flex-column p-3 cont">
                    <article class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl p-4 mb-4">
            ...
            <div class="col-12 col-lg-4">
                <aside class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl p-4 mb-4">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-1 row-cols-xl-1 gap-4 mb-4">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-12 col-xl-12">
                        <div class="bg-white bg-opacity-40 backdrop-blur-2xl rounded-2xl p-4">
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 gap-4">
    ...
    <div class="container py-5" style="background-color: #f6f9ff; border-radius: 20px;">
        <div class="row">
            <div class="col-12 col-lg-8 cont">
                <div class="bg-white rounded-2xl p-4 mb-4" style="background-color: #f6f9ff;">
                    <div class="d-flex justify-content-between">
                        <p class="text-dark">
                            <span class="font-weight-medium border-bottom border-dashed border-danger">Últimas
                                entradas</span>
                ...
                <div class="h-100 d-flex flex-column p-3 cont" style="background-color: #f6f9ff;">
                    <article class="bg-white rounded-2xl p-4 mb-4" style="background-color: #f6f9ff;">
                        <div class="h-100 d-flex flex-column justify-content-between">
                            <div class="row gap-4">
                                <img src="assets/images/widgets/sm-3.jpg" alt="" class="img-fluid rounded-xl">
                            </div>
                            <div class="col-12 col-sm-6 col-md-8">
                                <div class="w-100">
                                    <span class="text-sm bg-danger text-danger rounded font-weight-medium py-1 px-2 inline-block mb-3">Health</span>
                                    <span class="text-dark font-weight-medium text-xs ms-2">{{ now()->formatLocalized('%d %B %Y') }}</span>
                                </div>
                                <a href="#" class="text-xl mb-5 md:mb-0 font-spectral font-semibold text-dark block">
                                    This is the best Blogs card for your business template.
                                </a>
                                <div class="d-flex flex-wrap justify-content-between mt-auto">
                                    <div class="d-flex align-items-center">
                                        <div class="w-8 h-8 rounded">
                                            <img class="img-fluid rounded-circle" src="assets/images/users/avatar-1.jpg" alt="logo">
                                        </div>
                                        <div class="ms-2">
                                            <a tabindex="0" class="cursor-pointer hover-text-secondary text-dark focus-text-secondary text-dark focus-underline">
                                                <h5 class="font-weight-medium text-sm">Fitbit Incorporation</h5>
                                            </a>
                                            <p tabindex="0" class="text-secondary text-xs font-weight-medium">San Diego,
                                                California</p>
                                    ...
                                    <a href="#" class="block text-secondary hover-text-primary text-decoration-underline text-decoration-dashed text-decoration-primary font-weight-medium">
                                        Read More
            ...
            <div class="col-12 col-lg-4">
                <aside class="bg-white rounded-2xl p-4 mb-4" style="background-color: #f6f9ff;">
                    <span class="font-weight-medium border-bottom border-dashed border-danger text-secondary">Noticias Relacionadas</span>
                </aside>
                <div class="row gap-4 mb-4">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-12 col-xl-12">
                        <div class="bg-white rounded-2xl p-4" style="background-color: #f6f9ff;">
                            <div class="row gap-4">
                                <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    <img src="assets/images/widgets/sm-2.jpg" alt="" class="img-fluid rounded-xl">
                                </div>
                                <div class="col-12 col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                    <div class="h-100 d-flex flex-column p-3">
                                        <div class="w-100">
                                            <span class="text-sm bg-success text-success rounded font-weight-medium py-0 px-2 inline-block mb-3">Fashion</span>
                                            <span class="text-dark font-weight-medium text-xs ms-2">23 August 2023</span>
                                        </div>
                                        <a href="#" class="text-lg font-weight-semibold text-secondary block">
                                            This is the best Blogs card for your.
