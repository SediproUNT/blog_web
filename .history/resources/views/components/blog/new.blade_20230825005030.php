...
@section('contenido')
    ...
    <section class="mil-p-120-120">
        <div class="container">
            <div class="swiper-container mil-works-slider">
    ...
    <!-- Agrega los enlaces a los archivos de la biblioteca Swiper (CSS y JS) aquí -->
    ...
    <script>
        var swiper = new Swiper('.swiper-container', {
            ...
            slidesPerView: 'auto', // Ajusta según tus necesidades
            spaceBetween: 30, // Ajusta según tus necesidades
