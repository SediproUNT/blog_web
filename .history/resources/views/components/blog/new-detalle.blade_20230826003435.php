        ...
        <div class="mil-pagination mil-hidden-button">
            @if ($nextPostId)
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next"
                        href="{{ route('news.show', ['id' => $nextPostId]) }}"><i class="fas fa-arrow-left"></i><span class="mil-h6">Más reciente</span></a></div>
            @else
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next disabled"><i class="fas fa-arrow-left"></i><span class="mil-h6">Más
                            reciente</span></a></div>
            @endif
