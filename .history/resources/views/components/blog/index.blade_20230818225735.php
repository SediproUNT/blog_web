...
@section('styles')
    <style>
        .custom-image {
            max-width: 100px; /* Reducir el ancho según tu preferencia */
            height: auto;
        }
    </style>
@endsection
            ...
            <div class="slick-slider">
                @foreach ($logros as $logro)
                    <div class="slick-slide">
                        <img src="{{ $logro->url_logros }}" alt="" class="img-fluid mx-auto d-block custom-image">
                    </div>
                @endforeach
            </div>
        </div>
...
<style>
    .custom-image {
        width: 187px; /* Ajusta el ancho según tu preferencia */
        height: auto;
    }
</style>
