...
@section('styles')
    <style>
        ...
        .mil-card .mil-cover-frame {
    position: relative;
    width: 100%; /* Ajusta este valor según el tamaño deseado de la imagen principal */
    height: 0;
    padding-bottom: 100%; /* Ajusta este valor según la relación de aspecto de tus imágenes */
    background-size: contain;
    background-repeat: no-repeat;
    background-position: center;
