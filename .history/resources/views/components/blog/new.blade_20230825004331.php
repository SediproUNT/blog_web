        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-6 mil-mb-60">
                    <div class="mil-project-cover"><img src="img/projects/2.jpg" alt="Project"></div>
                </div>
                <div class="col-xl-5 mil-mb-60"><span class="mil-suptitle mil-suptitle-2 mil-mb-30">The majority have
                        suffered alteration in some form.</span>
                    <h3 class="mil-mb-30">Android App For Shaving Products Delivery</h3><a class="mil-button-with-label"
                        href="/project">
            ...
            <div class="row flex-sm-row-reverse justify-content-between align-items-center">
                <div class="col-xl-6 mil-mb-60">
                    <div class="mil-project-cover mil-type-2"><img src="img/projects/3.jpg" alt="Project"></div>
                </div>
                <div class="col-xl-5 mil-mb-60"><span class="mil-suptitle mil-suptitle-2 mil-mb-30">The majority have
                        suffered alteration in some form.</span>
                    <h3 class="mil-mb-30">Android App For Shaving Products Delivery</h3><a class="mil-button-with-label"
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-6 mil-mb-60">
                    <div class="mil-project-cover"><img src="img/projects/1.jpg" alt="Project"></div>
                </div>
                <div class="col-xl-5 mil-mb-60"><span class="mil-suptitle mil-suptitle-2 mil-mb-30">The majority have
                        suffered alteration in some form.</span>
                    <h3 class="mil-mb-30">Android App For Shaving Products Delivery</h3><a class="mil-button-with-label"
            ...
            <div class="mil-pagination mil-hidden-arrows">
                ...
                <ul class="mil-pagination-numbers">
                    <li class="mil-active"><a href="/portfolio">1</a></li>
