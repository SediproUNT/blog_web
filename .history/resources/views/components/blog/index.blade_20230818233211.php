...
<style>
    ...
    .slick-slider .slick-next {
        background-color: blue; /* Cambiar el color de los botones a azul */
        color: white; /* Cambiar el color del texto de los botones a blanco */
    }

    .slick-slider .slick-prev {
        left: -30px; /* Ajustar la posición del botón "Anterior" */
    }

    .slick-slider .slick-next {
        right: -30px; /* Ajustar la posición del botón "Siguiente" */
    }
</style>
@endsection
