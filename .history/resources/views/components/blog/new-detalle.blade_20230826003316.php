        ...
        <div class="mil-pagination mil-hidden-button">
            @if ($nextPostId)
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next"
                        href="{{ route('news.show', ['id' => $nextPostId]) }}"><span class="mil-h6">Más reciente</span><i
                            class="fas fa-arrow-right"></i><span class="mil-h6">Más
                                reciente </span></a></div>
            @else
                <div class="mil-slider-nav"><a class="mil-slider-btn-next mil-blog-next disabled"><i class="fas fa-arrow-right"></i><span class="mil-h6">Más
                    reciente </span></a></div>
            @endif
            ...
            @if ($previousPostId)
                <a class="mil-slider-nav" href="{{ route('news.show', ['id' => $previousPostId]) }}">
                    <div class="mil-slider-btn-prev mil-button-sm mil-blog-prev">
                        <span class="mil-h6">Más antiguos</span><i class="fas fa-arrow-left"></i>
                    </div>
                </a>
            @else
                <div class="mil-slider-btn-prev mil-button-sm mil-blog-prev disabled">
                    <span class="mil-h6">Más antiguos</span>
