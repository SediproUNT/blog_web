                ...
                <div class="col-md-6 col-xl-6">
                    <div class="mil-adaptive-right">
                        <div class="mil-slider-nav mil-mb-30">
                            <div class="mil-slider-btn-prev swiper-button-prev"><i class="fas fa-arrow-left"></i><span class="mil-h6">Prev</span></div>
<div class="mil-slider-btn-next swiper-button-next"><span class="mil-h6">Next</span><i class="fas fa-arrow-right"></i></div>
