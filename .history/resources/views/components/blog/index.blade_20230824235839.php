                ...
                <div class="col-md-6 col-xl-6">
                    <div class="mil-adaptive-right">
                        <div class="mil-slider-nav mil-mb-30">
                            ...
                            <div class="mil-slider-btn-prev mil-works-prev swiper-button-disabled swiper-button-prev" tabindex="-1"
                                role="button" aria-label="Previous slide">
                                <i class="fas fa-arrow-left"></i><span class="mil-h6">Prev</span>
                            </div>
                            <div class="mil-slider-btn-next mil-works-next swiper-button-next" tabindex="0" role="button"
