        ...
        <div class="container">
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-xl-5 mil-mb-60">
                    <span class="mil-suptitle mil-suptitle-2 mil-mb-30">{{ $post->created_at->format('d F Y') }}</span>
                    <h3 class="mil-mb-30">{{ \Illuminate\Support\Str::limit($post->body, 30) }}</h3>
            ...
            <div class="mil-pagination mil-hidden-arrows">
                ...
                <ul class="mil-pagination-numbers">
                    ...
                    <!-- Agrega más números de página según la cantidad de posts -->
                </ul>
                <div class="mil-slider-nav">
