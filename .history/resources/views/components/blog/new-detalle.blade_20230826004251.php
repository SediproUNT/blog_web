...
@section('styles')
    <style>
        ...
        .more-ancient-link:hover .mil-h6 {
            color: #999;
            /* Cambia este color según tus preferencias */
            cursor: default;
        }

        /* Cambia el color del icono al pasar por encima */
        .more-ancient-link:hover .fa-arrow-right {
            color: #999;
            /* Cambia este color según tus preferencias */
        }
    </style>
...
@section('contenido')
    ...
    <div class="container mil-mb-120">
        <div class="mil-pagination mil-hidden-button">
            ...
            @if ($nextPostId)
                <div class="mil-slider-nav  more-ancient-link"><a class="mil-slider-btn-next mil-blog-next"
                        href="{{ route('news.show', ['id' => $nextPostId]) }}"><span class="mil-h6">Más antiguos</span><i
                            class="fas fa-arrow-right"></i></a></div>
            @else
                <div class="mil-slider-nav  more-ancient-link"><a class="mil-slider-btn-next mil-blog-next disabled"><span class="mil-h6">Más
