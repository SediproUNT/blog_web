                    ...
                    @if ($index % 2 == 0)
                        ...
                        <div class="col-xl-5 mil-mb-60">
                            ...
                            <   <div class="mil-button mil-border mil-icon-button"><span><i class="fas fa-plus"></i></span>
                                ...
                                <a class="mil-button-with-label" href="{{ route('posts.show', $post) }}" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: white; text-decoration: none; border-radius: 5px;">
                             span class="mil-dark">Mas información</span>
                            </a>
