    ...
    <section class="bg-light">
        ...
        <div class="container">
                        ...
                        <a class="mil-card" href="/project">
                            ...
                            <div class="mil-description">
                                <div class="mil-card-title">
                                    ...
                                    <h6>Fecha: <span class="mil-accent">{{ $post->created_at->format('d-m-Y') }}</span></h6>
                                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-xl-6"><a class="mil-link mil-mb-30" href="/portfolio"><span>Ver todas las noticias</span><i class="fas fa-arrow-right"></i></a></div>
            </div>
        </div>
