        ...
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    >
                    <a href="{{ route('login.google') }}" class="btn btn-primary btn-lg">
                        <img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png" alt="Google"> Iniciar sesión con Google
                      </a>
