...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $factory = (new Factory)
        //     ->withServiceAccount(ServiceAccount::fromJsonFile(config('resources/credenciales/sedipro-393405-firebase-adminsdk-lr4w3-1b3929126f.json')))
        //     ->create();
   ...
   $defaultBucket->upload($file, [
       'name' => 'path/in/storage/image.jpg'
   ]);
