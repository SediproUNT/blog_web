...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('photo')->nullable(); // Agregamos el campo photo
            $table->string('last_name')->nullable(); // Agregamos el campo last_name
            ...
            $table->string('google_id')->nullable();     // Agregamos el campo provider
            $table->rememberToken();
            $table->timestamps();
        });
    }
